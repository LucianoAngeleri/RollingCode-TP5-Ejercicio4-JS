setInterval(() => {
  ...
  textoHs.innerHTML = `${hs}<small class="fs-6 ps-1 d-none d-md-inline">hs</small>`;
  textoMin.innerHTML = `${min}<small class="fs-6 ps-1 d-none d-md-inline">min</small>`;
  textoSeg.innerHTML = `${seg}<small class="fs-6 ps-1 d-none d-md-inline">seg</small>`;
